...
function fillData(data){
    ...
    $.each(data,function(k,v){
        ...
        html += '<td><a class="c-50a73f mlr-6" href="javascript:void(0)" onclick="showDetail(\''+ v.id+'\')">查看</a><a class="c-50a73f mlr-6" href="javascript:void(0)" onclick="edit(\''+ v.id+'\')">修改</a>' +
            '<a class="c-50a73f mlr-6" href="javascript:void(0)" onclick="del(\''+ v.id+'\')">删除</a><a class="c-50a73f mlr-6" href="javascript:void(0)" onclick="userlist(\''+ v.id+'\')">用户</a></td>';
        html +='</tr>' ;
...
function userlist(id){
    $.get("./userlist/"+id,{ts:new Date().getTime()},function(data){
        art.dialog({
            lock:true,
            opacity:0.3,
            title: "查看信息",
